...
class TabBarController: XQUITabBarController
{
    ...
    override func viewDidLoad() {
        ...
        let tab1 = UINavigationController(rootViewController:self.TabRootController!)
        ...
        let tab2 = UINavigationController(rootViewController:self.TabRootController!)
        ...
        //tab3
        self.TabRootController = test2()
        let tab3 = UINavigationController(rootViewController:self.TabRootController!)
        ...
        //tab4
        self.TabRootController = test2()
        let tab4 = UINavigationController(rootViewController:self.TabRootController!)
        ...
        //tab5
        self.TabRootController = test2()
        let tab5 = UINavigationController(rootViewController:self.TabRootController!)
